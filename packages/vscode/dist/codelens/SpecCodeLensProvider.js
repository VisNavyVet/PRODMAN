...
exports.SpecCodeLensProvider = void 0;
...
class SpecCodeLensProvider {
    provideCodeLenses(document) {
        if (path.basename(document.fileName) !== 'agent-brief.md')
            return [];
...
exports.SpecCodeLensProvider = SpecCodeLensProvider;
//# sourceMappingURL=SpecCodeLensProvider.js.map