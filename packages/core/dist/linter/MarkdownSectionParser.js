...
exports.normaliseHeading = normaliseHeading;
exports.parseMarkdownSections = parseMarkdownSections;
exports.countBulletItems = countBulletItems;
exports.extractBulletItems = extractBulletItems;
...
function countBulletItems(section) {
    return section.lines.filter(line => /^\s*[-*•]\s+\S/.test(line) ||
        /^\s*\d+\.\s+\S/.test(line) ||
        /^\s*-\s+\[[ x]\]\s+\S/.test(line)).length;
}
/**
...
//# sourceMappingURL=MarkdownSectionParser.js.map